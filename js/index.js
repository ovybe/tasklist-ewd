$(".lists").css("padding-left",0);
$(".listsmonth").css("padding-left",0);
// scheduler
      ...
      $.ajax({
            ...
            success: function(dataResult){
              ...
              if (!dataResult.hasOwnProperty('empty')){
                //trebuie sa adaug in lista
                console.log(dataResult);
                  $("#sortable1").append('<li style="background-color:'+CURRENT_TEAM_COLOR+'" data-task="'+dataResult['task_id']+'" data-before="'+datetime[0]+'" data-after="'+datetime[1]+'" class="ui-state-default"><span class="task-text">'+task_string+'</span><div class="toolbar"><button data-action="edit" class="toolbar_button">=</button><button data-action="delete" class="toolbar_button">X</button></div></li>');
